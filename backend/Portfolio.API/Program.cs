...
builder.Services.AddScoped<ISiteSettingsPutterRepository, SiteSettingsPutterRepository>();
builder.Services.AddScoped<ISiteSettingsGetterRepository, SiteSettingsGetterRepository>();
...
builder.Services.AddScoped<ISiteSettingsPutterService, SiteSettingsPutterService>();
builder.Services.AddScoped<ISiteSettingsGetterService, SiteSettingsGetterService>();
builder.Services.AddScoped<IPasswordPutterService, PasswordPutterService>();
builder.Services.AddScoped<IEmailGetterService, EmailGetterService>();
builder.Services.AddScoped<IEmailPutterService, EmailPutterService>();
builder.Services.AddScoped<IAccountDeleterService, AccountDeleterService>();
