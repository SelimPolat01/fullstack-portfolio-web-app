...
export default function HalfCircleProgress({
  ...
  const texts = {
    tr: { cashInfos: ["Hedef", "Hasılat", "Bugün"] },
      ...
      <div className={classes.subDiv}>
        <div className={classes.textDiv}>
          <div className={classes.infoItem}>
            <span className={classes.textCash}>{texts[lang].cashInfos[0]}</span>
          ...
          <div className={classes.infoItem}>
            <span className={classes.textCash}>{texts[lang].cashInfos[1]}</span>
            <div className={classes.cashIconContainer}>
          ...
          <div className={classes.infoItem}>
            <span className={classes.textCash}>{texts[lang].cashInfos[2]}</span>
            <div className={classes.cashIconContainer}>
              <h2 className={classes.money}>{todayValue}</h2>
